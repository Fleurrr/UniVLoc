...
def generate_image_meta_pickle(dataset_root: str):
    ...
    intrinsic_path = './models'
    extrinsic_path = './extrinsics'
...
def generate_training_tuples(ds: OxfordSequences, pos_threshold: float = 10, neg_threshold: float = 50, sph: bool = False):
    ...
    for anchor_ndx in tqdm.tqdm(range(len(ds))):
        ...
        # sph_img = generate_sph_image(images, 'oxford', "/map-hl/gary.huang/public_dataset/Oxford/dataset/image_meta.pkl", ds.dataset_root)
