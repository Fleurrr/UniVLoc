...
_C.data.dataset_path = '/map-hl/gary.huang/Visual_Loop_Closure/finetune/'
_C.data.loop_pkl_path_train = './dataset/loop_closure_o2_i2_n3_U_l700_finetune.pkl'
_C.data.loop_pkl_path_eval = './dataset/loop_closure_finetune_eval.pkl'
_C.data.with_amb = False
_C.data.img_width = 448
_C.data.img_height = 256
_C.data.dataset_length = 8000
_C.data.neg_num = 1
