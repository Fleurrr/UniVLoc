...
_C.exp_name = 'place_recognition_baseline_nclt'
...
# dataset
_C.data = edict()
_C.data.dataset = 'nclt'
_C.data.dataset_path = '/map-hl/gary.huang/public_dataset/NCLT/'
_C.data.loop_pkl_path_train = 'train_2012-02-04_2012-03-17_2.0_3.0.pickle'
_C.data.loop_pkl_path_eval = 'test_2012-02-04_2012-03-17_0.2.pickle'
