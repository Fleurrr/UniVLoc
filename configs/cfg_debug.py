...
_C.data.loop_pkl_path_train = './dataset/loop_closure_5_30_140_amb_limited_sample.pkl'#'./dataset/loop_closure.pkl'
_C.data.loop_pkl_path_eval = './dataset/loop_closure_eval.pkl'
_C.data.with_amb = False
_C.data.img_width = 448 // 4
_C.data.img_height = 256  // 4
...
_C.loss.pose_loss_weight = 0.1
_C.loss.desc_loss_weight = 1.
_C.loss.match_loss_weight = 1.
...
_C.match_loss.positive_distance = 0.6
...
# localizer
_C.localizer = edict()
_C.localizer.pose_estimate = 'polar' # regress, match, query, polar
_C.localizer.loop_detect = 'netvlad' # distance, query, disco, netvlad
_C.localizer.geo_emb = False
_C.localizer.loop_interact = False
_C.localizer.loop_thresh = 0.1
_C.localizer.estimate_translation = False
_C.localizer.searching = False
# for regress
_C.localizer.desc_dim = 512
_C.localizer.pose_dim = 1 # 1: yaw 2: xy 3:3-dof 4:rot 7: 6-dof
# for query
_C.localizer.num_layers = 4
_C.localizer.num_heads = 4
# for matching
_C.localizer.use_mask = True
_C.localizer.pos_radius = 0.6 # for matching
