...
_C.exp_name = 'place_recognition_baseline_oxford'
...
# dataset
_C.data = edict()
_C.data.dataset = 'oxford'
_C.data.dataset_path = '/map-hl/gary.huang/public_dataset/Oxford/dataset/'
_C.data.loop_pkl_path_train = 'train_2019-01-11-13-24-51-radar-oxford-10k_2019-01-15-13-06-37-radar-oxford-10k_2.0_3.0.pickle'
_C.data.loop_pkl_path_eval = 'test_2019-01-11-13-24-51-radar-oxford-10k_2019-01-15-13-06-37-radar-oxford-10k_0.2.pickle'
_C.data.param_path = ['./prnet/config/deformable/config_deformable.txt', './prnet/config/deformable/deformable.txt']
...
# loss function
_C.loss = edict()
_C.loss.margin_triplet = 0.2
_C.loss.margin_pos = 0.1
_C.loss.margin_neg = 0.3
...
_C.localizer.loop_detect = 'disco' # distance, query, disco, pdistance, netvlad
