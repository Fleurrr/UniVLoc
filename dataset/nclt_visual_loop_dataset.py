...
class TrainingDatasetRaw(Dataset):
    ...
    def __getitem__(self, ndx):
        ...
        return query_pc, query_imgs, ndx, query_yaw  #(N, 3), (S, 3, H, W), index, 
...
class  NCLTVisualLoopDataset(Dataset):
    ...
    # def get_positives(self, ndx):
    #     return self.unused_infos[ndx].positives

    # def get_non_negatives(self, ndx):
    #     return self.unused_infos[ndx].non_negatives
...
if __name__ == "__main__":
    ...
    params.print()
    dataset = NCLTVisualLoopDataset(dataset_path='/map-hl/gary.huang/public_dataset/NCLT/',  \
                                                            dataset_type='nclt', query_filename='train_2012-02-04_2012-03-17_2.0_10.0.pickle', params=params)
    data = dataset[1]